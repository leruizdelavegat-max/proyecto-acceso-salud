...
Generado: 2026-09-08T20:33:49+00:00

| Dataset | Regla | Evaluados | Marcados | % | Acción | Motivo |
|---|---|---:|---:|---:|---|---|
| renipress | encoding_archivo | 1 | 0 | 0.0% | leído como utf-8-sig | decodifica con el encoding de config.md |
| renipress | encoding_texto_utf8_vs_latin1 | 35471 | 4 | 0.01% | corregido | mojibake conocido (ÿ→ñ) y doble codificación utf-8/latin-1 |
| renipress | coordenadas_vacias_o_no_numericas | 35471 | 13147 | 37.06% | eliminado | sin coordenada numérica no se puede rutear en la Fase 2 |
| renipress | coordenadas_en_cero | 35471 | 7 | 0.02% | eliminado | /valor/ < 1e-06 se trata como nulo, no como posición real cerca de (0,0) |
