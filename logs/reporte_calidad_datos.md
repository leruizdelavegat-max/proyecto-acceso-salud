...
Generado: 2026-09-08T14:49:53+00:00
...
| codificacion_texto_utf8_vs_latin1 | 4 | — | corregido | reemplazo de mojibake conocido (ÿ->ñ, Ÿ->Ñ) y reversión de doble codificación UTF-8/Latin-1 en campos de texto |
...
| coordenadas_cero | 7 | 0.02% | eliminado | /valor/ < 1e-06 se trata como centinela de nulo, no como coordenada real |
...
| codificacion_texto_utf8_vs_latin1 | 0 | — | sin problemas detectados | reemplazo de mojibake conocido (ÿ->ñ, Ÿ->Ñ) y reversión de doble codificación UTF-8/Latin-1 en campos de texto |
